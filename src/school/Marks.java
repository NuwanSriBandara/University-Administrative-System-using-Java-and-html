...
public class Marks extends javax.swing.JFrame {
 ...
 interface Settingzeross{
  ...
  public void getemarkstable(){
      try{
            DefaultTableModel dtm=(DefaultTableModel)examtable.getModel();
            dtm.setRowCount(0);
            Conn.Database.getDatabaseConnection();
            PreparedStatement ps=Conn.Database.con.prepareStatement("Select * from exammarks where username=?" );
            ps.setString(1,username.getText());
            ResultSet rs=ps.executeQuery();
            if(rs.next()){
            Object dataRecord[]={rs.getInt("ExamID"),rs.getString("Examname"),rs.getString("ExamCode"),rs.getDouble("TotalGPA"),rs.getDouble("gotMarks"),rs.getDouble("gotGPA")};
  ...
  public void getcmarkstable(){
      try{
            DefaultTableModel dtm=(DefaultTableModel)cattable.getModel();
            dtm.setRowCount(0);
            Conn.Database.getDatabaseConnection();
            PreparedStatement ps=Conn.Database.con.prepareStatement("Select * from catMarks where username=?" );
            ps.setString(1,username.getText());
            ResultSet rs=ps.executeQuery();
            if(rs.next()){
            Object dataRecord[]={rs.getInt("CATID"),rs.getString("CATname"),rs.getString("CATCode"),rs.getDouble("TotalGPA"),rs.getDouble("gotMarks"),rs.getDouble("gotGPA")};
            dtm.addRow(dataRecord);
            }
  ...
  public void getpmarkstable(){
      try{
            DefaultTableModel dtm=(DefaultTableModel)projecttable.getModel();
            dtm.setRowCount(0);
            Conn.Database.getDatabaseConnection();
            PreparedStatement ps=Conn.Database.con.prepareStatement("Select * from projectsMarks where username=?" );
            ps.setString(1,username.getText());
            ResultSet rs=ps.executeQuery();
            if(rs.next()){
            Object dataRecord[]={rs.getInt("ProjectID"),rs.getString("Projectname"),rs.getString("ProjectCode"),rs.getDouble("TotalGPA"),rs.getDouble("gotMarks"),rs.getDouble("gotGPA")};
            dtm.addRow(dataRecord);
            }
            if(projecttable.getRowCount()<1){
              //JOptionPane.showMessageDialog(this, "No Search Results Found for Exams !  ");
           }
            Conn.Database.disconnectDatabase();
        }catch(HeadlessException x){
    ...
    private void initComponents() {
        ...
        setTitle("Your Progression in Marks");
        ...
        jLabel2.setText("Marks at Examinations");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 150, 250, 30));

        jLabel3.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        jLabel3.setText("Marks at Continuous Assesments ( CAT )");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 350, 450, 30));

        jLabel4.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        jLabel4.setText("Marks at Projects");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 550, 250, 30));
        ...
        projecttable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Project ID", "Project  Name", "Project Code", "Total GPA Fraction", "Got Marks", "Got GPA Fraction"
            }
        ) {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 620, 1000, 90));
        ...
        examtable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Exam ID", "Exam Name", "Exam Code", "Total GPA Fraction", "Got Marks", "Got GPA Fraction"
            }
        ) {
            Class[] types = new Class [] {
        ...
        cattable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CAT ID", "CAT Name", "CAT Code", "Total GPA Fraction", "Got Marks", "Got GPA Fraction"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Integer.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class
        ...
        getContentPane().add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 420, 1000, 90));
        ...
        getContentPane().add(username, new org.netbeans.lib.awtextra.AbsoluteConstraints(1530, 600, 220, 40));
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/gif 1.gif"))); // NOI18N
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(18, 166, 240, 540));

        jLabel20.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        jLabel20.setText("* Here, Total GPA Fractions are based on SEMESTER-Wise, that means Addition of those GPA Fractions of all the Examinations, CAT and/or Projects within one semester equals to 4.0  ");
        getContentPane().add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 735, -1, -1));
        ...
        Searchtable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "Code", "Total GPA Fraction", "Got Marks", "Got GPA Fraction"
            }
        ));
        jScrollPane4.setViewportView(Searchtable);

        getContentPane().add(jScrollPane4, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 820, 1000, 80));
    ...
    private void SearchbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchbuttonActionPerformed
      if(Search.getText().isEmpty()){
          ...
          try{
             ...
             dtm.setRowCount(0); 
             Conn.Database.getDatabaseConnection();
             PreparedStatement ps=Conn.Database.con.prepareStatement("Select * from exammarks where (examname like '%"+Search.getText()+"%' or examcode like '%"+Search.getText()+"%'  or totalgpa like '"+Double.valueOf(Search.getText())+"' or gotmarks like '"+Double.valueOf(Search.getText())+"' or gotgpa like '"+Double.valueOf(Search.getText())+"') and username=? " );
             ps.setString(1, username.getText());
             ResultSet rs=ps.executeQuery();
             while(rs.next()){
                 Object dataRecord[]={rs.getString("examid"),rs.getString("examname"),rs.getString("examcode"),rs.getString("totalgpa"),rs.getString("gotmarks"),rs.getString("gotgpa")};
                 dtm.addRow(dataRecord);
             }
             PreparedStatement ps1=Conn.Database.con.prepareStatement("Select * from catmarks where (catname like '%"+Search.getText()+"%' or catcode like '%"+Search.getText()+"%'  or totalgpa like '"+Double.valueOf(Search.getText())+"' or gotmarks like '"+Double.valueOf(Search.getText())+"' or gotgpa like '"+Double.valueOf(Search.getText())+"') and username=? " );
             ps1.setString(1, username.getText());
             ResultSet rs1=ps1.executeQuery();
             while(rs1.next()){
                 Object dataRecord1[]={rs1.getString("catid"),rs1.getString("catname"),rs1.getString("catcode"),rs1.getString("totalgpa"),rs1.getString("gotmarks"),rs1.getString("gotgpa")};
                 dtm.addRow(dataRecord1);
             }
             PreparedStatement ps2=Conn.Database.con.prepareStatement("Select * from catmarks where (catname like '%"+Search.getText()+"%' or catcode like '%"+Search.getText()+"%'  or totalgpa like '"+Double.valueOf(Search.getText())+"' or gotmarks like '"+Double.valueOf(Search.getText())+"' or gotgpa like '"+Double.valueOf(Search.getText())+"') and username=? " );
             ps2.setString(1, username.getText());
              ResultSet rs2=ps1.executeQuery();
              while(rs2.next()){
                  Object dataRecord2[]={rs2.getString("catid"),rs2.getString("catname"),rs2.getString("catcode"),rs2.getString("totalgpa"),rs2.getString("gotmarks"),rs2.getString("gotgpa")};
    ...
    private void SearchKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_SearchKeyPressed
      if(evt.getKeyCode()==KeyEvent.VK_ENTER){
          ...
          try{
             ...
             dtm.setRowCount(0); 
             Conn.Database.getDatabaseConnection();
             PreparedStatement ps=Conn.Database.con.prepareStatement("Select * from exammarks where (examname like '%"+Search.getText()+"%' or examcode like '%"+Search.getText()+"%'  or totalgpa like '%"+Search.getText()+"%' or gotmarks like '%"+Search.getText()+"%' or gotgpa like '%"+Search.getText()+"%') and username=? " );
             ps.setString(1, username.getText());
             ResultSet rs=ps.executeQuery();
             while(rs.next()){
                 Object dataRecord[]={rs.getString("examid"),rs.getString("examname"),rs.getString("examcode"),rs.getString("totalgpa"),rs.getString("gotmarks"),rs.getString("gotgpa")};
             ...
             PreparedStatement ps1=Conn.Database.con.prepareStatement("Select * from catmarks where (catname like '%"+Search.getText()+"%' or catcode like '%"+Search.getText()+"%'  or totalgpa like '%"+Search.getText()+"%' or gotmarks like '%"+Search.getText()+"%' or gotgpa like '%"+Search.getText()+"%') and username=? " );
             ps1.setString(1, username.getText());
             ResultSet rs1=ps1.executeQuery();
             while(rs1.next()){
                 Object dataRecord1[]={rs1.getString("CATid"),rs1.getString("catname"),rs1.getString("catcode"),rs1.getString("totalgpa"),rs1.getString("gotmarks"),rs1.getString("gotgpa")};
             ...
             PreparedStatement ps2=Conn.Database.con.prepareStatement("Select * from projectsmarks where (projectname like '%"+Search.getText()+"%' or projectcode like '%"+Search.getText()+"%'  or totalgpa like '%"+Search.getText()+"%' or gotmarks like '%"+Search.getText()+"%' or gotgpa like '%"+Search.getText()+"%') and username=? " );
             ps2.setString(1, username.getText());
              ResultSet rs2=ps2.executeQuery();
              while(rs2.next()){
                  Object dataRecord2[]={rs2.getString("projectid"),rs2.getString("projectname"),rs2.getString("projectcode"),rs2.getString("totalgpa"),rs2.getString("gotmarks"),rs2.getString("gotgpa")};
                  dtm.addRow(dataRecord2);
              }
              jScrollPane4.setVisible(true);
              searchlabel.setVisible(true);
