 ...
 * @author HP
 */
public class PaymentsManagement extends javax.swing.JFrame {
 ...
 interface Settingzeross{
    ...
    private void initComponents() {
        ...
        setTitle("Payments Management at UoM");
        ...
        titlepayments.setFont(new java.awt.Font("Segoe UI", 0, 30)); // NOI18N
        titlepayments.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        titlepayments.setText("Payments Management");
        getContentPane().add(titlepayments, new org.netbeans.lib.awtextra.AbsoluteConstraints(385, 70, 400, 50));
        ...
        Table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Payment ID", "User Name", "Semester No", "Relevant Code", "Fee LKR", "Status"
            }
        ));
        ...
        paymentsM.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/user management.png"))); // NOI18N
        paymentsM.setText(" User Management");
        ...
        getContentPane().add(paymentsM, new org.netbeans.lib.awtextra.AbsoluteConstraints(1475, 760, 230, 40));
        ...
        paymentid.setFont(new java.awt.Font("Segoe UI", 0, 11)); // NOI18N
        getContentPane().add(paymentid, new org.netbeans.lib.awtextra.AbsoluteConstraints(1310, 350, 300, -1));
        ...
        fee.setFont(new java.awt.Font("Segoe UI", 0, 11)); // NOI18N
        fee.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                feeKeyPressed(evt);
            }
        });
        getContentPane().add(fee, new org.netbeans.lib.awtextra.AbsoluteConstraints(1310, 440, 300, -1));
    ...
    private void TableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TableMouseClicked
        ...
        paymentid.setText(Table.getValueAt(SelectedRow,0).toString());
        ...
        fee.setText(Table.getValueAt(SelectedRow,4).toString());
    ...
    private void txtSearchKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSearchKeyPressed
        ...
        if(evt.getKeyCode()==KeyEvent.VK_ENTER){
            try{
                ...
                PreparedStatement ps=Conn.Database.con.prepareStatement("Select * from payments where UserName like '%"+txtSearch.getText()+"%'");
                ...
                while(rs.next()){
                    ...
                    Object dataRecord[]={rs.getString("paymentID"),rs.getString("UserName"),rs.getString("semesterno"),rs.getString("relevantcode"),rs.getString("fee"),statusname};
    ...
    private void UpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdateActionPerformed
        if(txtUsername.getText().length()<1){
            ...
            try{
                ...
                Conn.Database.getDatabaseConnection();
                PreparedStatement ps=Conn.Database.con.prepareStatement("Insert into payments(semesterno,relevantcode,fee,status,username) values(?,?,?,?,?)");
                ps.setInt(1,Integer.valueOf(semesterno.getText()));
                ps.setString(2,relevantcode.getText());
                ps.setDouble(3,Double.valueOf(fee.getText()));
    ...
    private void RefreshActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RefreshActionPerformed
        try{
            ...
            String status;
            Conn.Database.getDatabaseConnection();
            PreparedStatement ps=Conn.Database.con.prepareStatement("Select * from payments");
            ResultSet rs=ps.executeQuery();
            ...
            while(rs.next()){
                if(rs.getInt("Status")==1){
                    ...
                    status="unpaid";
                } Object dataRecord[]={rs.getString("PaymentID"),rs.getString("UserName"),rs.getString("semesterno"),rs.getString("relevantcode"),rs.getString("fee"),status};
                dtm.addRow(dataRecord);
            }rs.close();
            if(Table.getRowCount()<1){
                JOptionPane.showMessageDialog(this, "No Search Results Found  !    ");
    ...
    private void DeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteActionPerformed
        if(txtUsername.getText().length()<1){
            ...
            if(option==JOptionPane.YES_OPTION){
                try{
                    Conn.Database.getDatabaseConnection();
                    PreparedStatement ps=Conn.Database.con.prepareStatement("delete from payments where Username=?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PaymentsManagement.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PaymentsManagement().setVisible(true);
            }
        });
    }
