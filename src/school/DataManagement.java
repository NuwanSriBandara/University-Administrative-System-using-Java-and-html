...
public class DataManagement extends javax.swing.JFrame {
 ...
 interface Settingzeross{
    ...
    private void initComponents() {
        ...
        setTitle("Primary User Management");
        ...
        titleuser.setFont(new java.awt.Font("Segoe UI", 0, 30)); // NOI18N
        titleuser.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        titleuser.setText("Primary User Management");
        getContentPane().add(titleuser, new org.netbeans.lib.awtextra.AbsoluteConstraints(385, 70, 400, 50));
        ...
        Table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "User ID", "User Name", "Full Name", "Gender", "UID", "hrtype", "Faculty", "Department", "Recorddate", "Email", "mobile"
            }
        ));
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 140, 1140, 240));

        jLabel2.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel2.setText("UID");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(1200, 590, -1, -1));
        ...
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(1200, 350, -1, -1));

        jLabel8.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel8.setText("Faculty");
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(1200, 410, -1, -1));

        jLabel9.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel9.setText("Department");
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(1200, 470, -1, -1));

        jLabel10.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel10.setText("HR Type");
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(1200, 530, -1, -1));

        jComboBox1.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Engineering", "Architecture", "Business Management", "Information Technology", "Graduate Studies", "Other" }));
        getContentPane().add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1310, 410, 300, 25));
        ...
        getContentPane().add(txtUID, new org.netbeans.lib.awtextra.AbsoluteConstraints(1310, 590, 200, -1));
        ...
        getContentPane().add(txtUserName, new org.netbeans.lib.awtextra.AbsoluteConstraints(1310, 230, 150, -1));
        ...
        hrtype.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        hrtype.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Senior Professor", "Professor", "Senior Lecturer G-1", "Senior Lecturer G-2", "Lecturer", "Assistant Lecturer", "Post Graduate student", "Student 4th Year", "Student 3rd Year", "Student 2nd Year", "Student 1st Year", "Non-Academic(Administrative Assist)", "Non-Academic(Laboratory)", "Student Councellor", "Medical Centre Staff Member", "Labour" }));
        hrtype.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                hrtypeFocusLost(evt);
            }
        });
        hrtype.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                hrtypeKeyPressed(evt);
            }
        });
        getContentPane().add(hrtype, new org.netbeans.lib.awtextra.AbsoluteConstraints(1310, 530, 300, -1));
        ...
        getContentPane().add(radioFemale, new org.netbeans.lib.awtextra.AbsoluteConstraints(1400, 350, -1, -1));

        radioMale.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        radioMale.setText("Male");
        getContentPane().add(radioMale, new org.netbeans.lib.awtextra.AbsoluteConstraints(1310, 350, -1, -1));

        jComboBox2.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Electrical & Power Systems Engineering", "Electronic Engineering", "BioMedical Engineering", "Civil Engineering", "Mechanical Engineering", "NDT", "Architecture & Interior Designing", "Business Management", "Business Administration", "Information Technology & Systems", "Postgraduate Studies" }));
        jComboBox2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jComboBox2ActionPerformed(evt);
            }
        });
        getContentPane().add(jComboBox2, new org.netbeans.lib.awtextra.AbsoluteConstraints(1310, 470, 300, -1));
        ...
        getContentPane().add(txtUserID, new org.netbeans.lib.awtextra.AbsoluteConstraints(1310, 170, 150, -1));
        ...
        getContentPane().add(examM, new org.netbeans.lib.awtextra.AbsoluteConstraints(1470, 650, 240, 40));
...
//        
    ...
    private void DeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteActionPerformed
       if(txtUserID.getText().length()<1){
           JOptionPane.showMessageDialog(this, "Specific user is NOT Selected !     ");
       }else{
       ...
       try{
           ...
           while(rs.next()){
               if(rs.getInt("Gender")==1){
                   ...
                   Gender="Female";
               } Object dataRecord[]={rs.getString("UserID"),rs.getString("UserName"),rs.getString("FullName"),Gender,rs.getString("UID"),rs.getString("hrtype"),rs.getString("Faculty"),rs.getString("Department"),rs.getString("RecordDate"),rs.getString("email"),rs.getString("mobile")};
    ...
    private void txtSearchKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSearchKeyPressed
        ...
        if(evt.getKeyCode()==KeyEvent.VK_ENTER){
           try{
               ...
               String Gender;
               Conn.Database.getDatabaseConnection();
               PreparedStatement ps=Conn.Database.con.prepareStatement("Select * from user where UID=? OR UserName like '%"+txtSearch.getText()+"%' OR FullName like '%"+txtSearch.getText()+"%'");
    ...
    private void UpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdateActionPerformed
       if(txtUserID.getText().length()<1){
           ...
           try{
               ...
               Conn.Database.getDatabaseConnection();
               PreparedStatement ps=Conn.Database.con.prepareStatement("Update user set FullName=?,gender=?,uid=?,Faculty=?,Department=?,username=?,email=?, mobile=?, hrtype=? where UserID=?");
               ...
               ps.setInt(10,Integer.valueOf(txtUserID.getText()));
               ps.setString(3,txtUID.getText());
               ps.setString(7, txtemail.getText());
               ps.setInt(8, Integer.valueOf(txtmobile.getText()));
               ps.setString(9, hrtype.getSelectedItem().toString());
               ps.executeUpdate();
    ...
    private void TableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TableMouseClicked
       ...
       txtFullName.setText(Table.getValueAt(SelectedRow,2).toString());
       if(Table.getValueAt(SelectedRow,3).toString().equals("Male")){
           radioMale.setSelected(true);
       }else if(Table.getValueAt(SelectedRow,3).toString().equals("Female")){
           radioFemale.setSelected(true);
       }
       txtUID.setText(Table.getValueAt(SelectedRow, 4).toString());
       hrtype.setSelectedItem(Table.getValueAt(SelectedRow, 5).toString());
       jComboBox1.setSelectedItem(Table.getValueAt(SelectedRow,6).toString());
       jComboBox2.setSelectedItem(Table.getValueAt(SelectedRow,7).toString());
       txtemail.setText(Table.getValueAt(SelectedRow, 9).toString());
       txtmobile.setText(Table.getValueAt(SelectedRow, 10).toString());
    ...
    private void hrtypeFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_hrtypeFocusLost
       //no part
    }//GEN-LAST:event_hrtypeFocusLost

    private void hrtypeKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_hrtypeKeyPressed
       //no part
    }//GEN-LAST:event_hrtypeKeyPressed
