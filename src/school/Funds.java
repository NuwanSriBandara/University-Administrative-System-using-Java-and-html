 ...
 interface Settingzeross{
    ...
    public void getpaymentstable(){
        try{
            ...
            PreparedStatement ps=Conn.Database.con.prepareStatement("Select * from payments where username=?" );
            ...
            Object dataRecord[]={rs.getString("PaymentID"),rs.getInt("Semesterno"),rs.getString("RelevantCode"),rs.getDouble("Fee"),Status};
    ...
    public void getfundstable(){
        try{
            DefaultTableModel dtm=(DefaultTableModel)Fundtable.getModel();
            dtm.setRowCount(0);
            String Status;
            Conn.Database.getDatabaseConnection();
            PreparedStatement ps=Conn.Database.con.prepareStatement("Select * from funds where username=?" );
            ps.setString(1,username.getText());
            ResultSet rs=ps.executeQuery();
            while(rs.next()){
                if(rs.getInt("status")==1){
            ...
            Object dataRecord[]={rs.getString("FundID"),rs.getInt("Semesterno"),rs.getString("RelevantCode"),rs.getDouble("Fund"),Status};
            dtm.addRow(dataRecord);
            }
            if(Fundtable.getRowCount()<1){
              //JOptionPane.showMessageDialog(this, "No Search Results Found for Exams !  ");
           }
            Conn.Database.disconnectDatabase();
        }catch(HeadlessException x){
    ...
    private void initComponents() {
        ...
        jLabel16.setText("University of Moratuwa");
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 375, 250, 30));

        jLabel3.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        jLabel3.setText("Payments");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 150, 250, 30));

        jLabel4.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel4.setText("It is your responsibility to learn for the Motherland as the people of Sri Lanka sacrifice thier precious Energy for you.");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 600, 1000, -1));
        jLabel4.getAccessibleContext().setAccessibleName("It is your responsibility to learn for the Motherland as the people of Sri Lanka sacrifice their precious Energy for you.");

        Fundtable.setFont(new java.awt.Font("Times New Roman", 0, 13)); // NOI18N
        Fundtable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "FundID", "Semester No", "Relevant Code", "Fund LKR", "Paid/Unpaid"
            }
        ));
        Fundtable.setEnabled(false);
        jScrollPane1.setViewportView(Fundtable);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 450, 1000, 90));

        Paymenttable.setFont(new java.awt.Font("Times New Roman", 0, 13)); // NOI18N
        Paymenttable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "PaymentID", "Semester No", "Relevant Code", "Fee LKR", "Paid/Unpaid"
            }
        ));
        ...
        getContentPane().add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(1350, 100, -1, 20));
        ...
        getContentPane().add(searchlabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 685, 140, 30));
        ...
        Searchtable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Semester No", "Code", "Financial Value LKR", "Paid/Unpaid"
            }
        ));
        jScrollPane5.setViewportView(Searchtable);

        getContentPane().add(jScrollPane5, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 730, 1000, 120));
    ...
    private void SearchbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchbuttonActionPerformed
         if(Search.getText().isEmpty()){
          ...
          try{
             ...
             String status;
             Conn.Database.getDatabaseConnection();
             PreparedStatement ps=Conn.Database.con.prepareStatement("Select * from funds where (semesterno like '%"+Search.getText()+"%' or relevantcode like '%"+Search.getText()+"%'  or fund like '%"+Search.getText()+"%' or status like '%"+Search.getText()+"%' ) and username=? " );
             ps.setString(1, username.getText());
             ResultSet rs=ps.executeQuery();
             while(rs.next()){
                 if(rs.getInt("status")==1){
                 ...
                 Object dataRecord[]={rs.getString("fundid"),rs.getString("semesterno"),rs.getString("relevantcode"),rs.getString("fund"),status};
                 dtm.addRow(dataRecord);
             }
             PreparedStatement ps1=Conn.Database.con.prepareStatement("Select * from payments where (semesterno like '%"+Search.getText()+"%' or relevantcode like '%"+Search.getText()+"%'  or fee like '%"+Search.getText()+"%' or status like '%"+Search.getText()+"%' ) and username=? " );
             ...
             while(rs1.next()){
                 ...
                 Object dataRecord1[]={rs1.getString("paymentid"),rs1.getString("semesterno"),rs1.getString("relevantcode"),rs1.getString("fee"),status};
