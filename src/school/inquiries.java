...
public class inquiries extends javax.swing.JFrame {
 ...
 interface Settingzeross{
    ...
    public inquiries() {
        initComponents();
        t.start();
        radiostatus.add(radiosolved);
        radiostatus.add(radionot);
        radionot.setSelected(true);
        sectionnametitle.setText(School.sectionname);
        getbuttons();
    }
    public void getbuttons(){
        if(sectionnametitle.getText().equals("Registration & HR")){
                    title="Basic Details";
                    examM.setEnabled(false);marksM.setEnabled(false);paymentsM.setEnabled(false);fundsM.setEnabled(false);salaryM.setEnabled(false);
                }else if(sectionnametitle.getText().equals("Examinations")){
                    title="Examinations & Marks";
                    userM.setEnabled(false);paymentsM.setEnabled(false);fundsM.setEnabled(false);salaryM.setEnabled(false);
                }else if(sectionnametitle.getText().equals("Accounting")){
                    title="Payments/Funds or Salary";
                    userM.setEnabled(false);examM.setEnabled(false);marksM.setEnabled(false);
                }
    }
    ...
    private void initComponents() {
        ...
        sectionnametitle = new javax.swing.JLabel();
        ...
        radiosolved = new javax.swing.JRadioButton();
        titlepayments1 = new javax.swing.JLabel();
        ...
        setTitle("Check your Inquiries, Admin ! ");
        ...
        sectionnametitle.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        sectionnametitle.setText("  [SectionName]");
        getContentPane().add(sectionnametitle, new org.netbeans.lib.awtextra.AbsoluteConstraints(646, 80, 510, 40));
        ...
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(1200, 630, -1, -1));

        jLabel12.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel12.setText("Email  Add");
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(1200, 290, -1, -1));

        jLabel4.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel4.setText("Mobile No");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(1200, 350, -1, -1));
        ...
        getContentPane().add(txtUsername, new org.netbeans.lib.awtextra.AbsoluteConstraints(1310, 170, 300, -1));

        txtUID.setFont(new java.awt.Font("Segoe UI", 0, 11)); // NOI18N
        getContentPane().add(txtUID, new org.netbeans.lib.awtextra.AbsoluteConstraints(1310, 230, 300, -1));

        txtFullName.setFont(new java.awt.Font("Segoe UI", 0, 11)); // NOI18N
        getContentPane().add(txtFullName, new org.netbeans.lib.awtextra.AbsoluteConstraints(1310, 410, 300, -1));
        ...
        getContentPane().add(txtemail, new org.netbeans.lib.awtextra.AbsoluteConstraints(1310, 290, 300, -1));
        ...
        getContentPane().add(txtmobile, new org.netbeans.lib.awtextra.AbsoluteConstraints(1310, 350, 300, -1));
        ...
        Table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Inquiry ID", "User Name", "UID", "email", "Title", "Main", "Sub", "How", "Data1", "Data2", "Recordtime", "Status"
            }
        ));
        ...
        jLabel8.setText("Inquiry ID");
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(1200, 510, -1, -1));

        jLabel9.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        jLabel9.setText("User name");
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(1200, 570, -1, -1));

        inquiryid.setFont(new java.awt.Font("Segoe UI", 0, 11)); // NOI18N
        getContentPane().add(inquiryid, new org.netbeans.lib.awtextra.AbsoluteConstraints(1310, 510, 300, -1));

        username.setFont(new java.awt.Font("Segoe UI", 0, 11)); // NOI18N
        getContentPane().add(username, new org.netbeans.lib.awtextra.AbsoluteConstraints(1310, 570, 300, -1));

        radionot.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        radionot.setText("Not Solved");
        getContentPane().add(radionot, new org.netbeans.lib.awtextra.AbsoluteConstraints(1420, 630, -1, -1));

        radiosolved.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        radiosolved.setText("Solved");
        getContentPane().add(radiosolved, new org.netbeans.lib.awtextra.AbsoluteConstraints(1310, 630, -1, -1));

        titlepayments1.setFont(new java.awt.Font("Segoe UI", 0, 30)); // NOI18N
        titlepayments1.setText("Inquiry Management -");
        getContentPane().add(titlepayments1, new org.netbeans.lib.awtextra.AbsoluteConstraints(335, 70, 310, 50));

        Update.setFont(new java.awt.Font("Segoe UI", 0, 22)); // NOI18N
        ...
        getContentPane().add(Update, new org.netbeans.lib.awtextra.AbsoluteConstraints(1500, 770, 170, 40));
        ...
        getContentPane().add(Delete, new org.netbeans.lib.awtextra.AbsoluteConstraints(1200, 825, 170, 40));
        ...
        getContentPane().add(Clearall, new org.netbeans.lib.awtextra.AbsoluteConstraints(1200, 770, 170, 40));
        ...
        getContentPane().add(Refresh, new org.netbeans.lib.awtextra.AbsoluteConstraints(1200, 715, 240, 40));
        ...
        getContentPane().add(examM, new org.netbeans.lib.awtextra.AbsoluteConstraints(910, 680, 230, 40));
        ...
        getContentPane().add(marksM, new org.netbeans.lib.awtextra.AbsoluteConstraints(910, 730, 230, 40));

        userM.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        userM.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/user management.png"))); // NOI18N
        userM.setText("  User Management");
        userM.setBorderPainted(false);
        userM.setContentAreaFilled(false);
        userM.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        userM.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                userMActionPerformed(evt);
            }
        });
        getContentPane().add(userM, new org.netbeans.lib.awtextra.AbsoluteConstraints(907, 780, 230, 40));
        ...
        getContentPane().add(fundsM, new org.netbeans.lib.awtextra.AbsoluteConstraints(905, 830, 240, 40));
        ...
        getContentPane().add(salaryM, new org.netbeans.lib.awtextra.AbsoluteConstraints(1180, 875, 280, 50));
        ...
        getContentPane().add(paymentsM, new org.netbeans.lib.awtextra.AbsoluteConstraints(903, 880, 270, 40));
    ...
    private void txtSearchKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSearchKeyPressed
        ...
        if(evt.getKeyCode()==KeyEvent.VK_ENTER){
            ...
            try{
                ...
                PreparedStatement ps=Conn.Database.con.prepareStatement("Select * from inquiry where UserName like '%"+txtSearch.getText()+"%' and title='"+title+"'");
                ...
                while(rs.next()){
                    ...
                    if(rs1.next()){
                        ...
                        Object dataRecord[]={rs.getString("InquiryID"),rs.getString("UserName"),rs.getString("uid"),rs.getString("email"),rs.getString("title"),rs.getString("main"),rs.getString("sub"),
                            rs.getString("how"),rs.getString("data1"),rs.getString("data2"),rs.getString("recordtime"),statusname};
    ...
    private void TableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TableMouseClicked
        ...
        inquiryid.setText(Table.getValueAt(SelectedRow,0).toString());
        txtUsername.setText(Table.getValueAt(SelectedRow,1).toString());
        username.setText(Table.getValueAt(SelectedRow, 1).toString());
        if(Table.getValueAt(SelectedRow,11).toString().equals("Solved")){
           radiosolved.setSelected(true);
        }else if(Table.getValueAt(SelectedRow,11).toString().equals("Unsolved")){
            radionot.setSelected(true);
        }
        ...
        if(txtUsername.getText().length()<1){
            ...
            try{
                ...
                if(radionot.isSelected()){
                    statusnumber=0;
                }else if(radiosolved.isSelected()){
                    statusnumber=1;
                }
                Conn.Database.getDatabaseConnection();
                if(sectionnametitle.getText().equals("Registration & HR")){
                ...
                PreparedStatement ps=Conn.Database.con.prepareStatement("Update inquiry set status=? where username=? and title='"+title+"' and inquiryid=?");
                ps.setInt(1, statusnumber);
                ps.setString(2, username.getText());
                ps.setInt(3, Integer.valueOf(inquiryid.getText()));

                ps.executeUpdate();
                JOptionPane.showMessageDialog(this, "Specifc data Updated Successfully !     ");
                Conn.Database.disconnectDatabase();
            }catch(HeadlessException x){
                JOptionPane.showMessageDialog(this, "Error: \n"+x);
            }catch(SQLException ex){
        ...
        if(txtUsername.getText().length()<1){
            ...
            if(option==JOptionPane.YES_OPTION){
                try{
                    ...
                    PreparedStatement ps=Conn.Database.con.prepareStatement("delete from inquiry where Username=? and title='"+title+"'");
                    ps.setString(1,txtUsername.getText());
                    ps.executeUpdate();
                    JOptionPane.showMessageDialog(this,"Specifc data Deleted Successfully !    ");
                    Conn.Database.disconnectDatabase();
    ...
    private void RefreshActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RefreshActionPerformed
        try{
            ...
            String status;
            Conn.Database.getDatabaseConnection();
            PreparedStatement ps=Conn.Database.con.prepareStatement("Select * from inquiry where title='"+title+"'");
            ResultSet rs=ps.executeQuery();
            ...
            while(rs.next()){
                ...
                Object dataRecord[]={rs.getString("InquiryID"),rs.getString("UserName"),rs.getString("uid"),rs.getString("email"),rs.getString("title"),rs.getString("main"),rs.getString("sub"),
                            rs.getString("how"),rs.getString("data1"),rs.getString("data2"),rs.getString("recordtime"),status};
                dtm.addRow(dataRecord);
            }//rs.close();
            if(Table.getRowCount()<1){
                JOptionPane.showMessageDialog(this, "No Search Results Found  !    ");
    ...
    private void userMActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_userMActionPerformed
        DataManagement p=new DataManagement();
        p.setVisible(true);
    ...
    private javax.swing.JRadioButton radiosolved;
    private javax.swing.ButtonGroup radiostatus;
    private javax.swing.JButton salaryM;
    private javax.swing.JLabel sectionnametitle;
    private javax.swing.JLabel titlepayments1;
